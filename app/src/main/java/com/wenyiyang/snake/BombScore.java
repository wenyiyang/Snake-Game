...
public class BombScore extends AppCompatActivity {
    ...
    // Initialize this activity and bomb score of the snake game.
    @Override
    ...
    // If enter the button, users will play bomb mode again.
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                playAgainView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(BombScore.this, BombSnake.class);
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                gotoMainMenu.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Animation animation1 = AnimationUtils.loadAnimation(BombScore.this, R.anim.reverse_for_classic_button);
                        animation1.setDuration(GameSettings.ANIMATION_CLOSE_BUTTON_DURATION);
                        Animation animation2 = AnimationUtils.loadAnimation(BombScore.this, R.anim.reverse_for_no_button);
                        animation2.setDuration(GameSettings.ANIMATION_CLOSE_BUTTON_DURATION);
                        Animation animation3 = AnimationUtils.loadAnimation(BombScore.this, R.anim.reverse_for_setting_button);
                        animation3.setDuration(GameSettings.ANIMATION_CLOSE_BUTTON_DURATION);
                        Animation animation4 = AnimationUtils.loadAnimation(BombScore.this, R.anim.reverse_for_bomb_button);
                        animation4.setDuration(GameSettings.ANIMATION_CLOSE_BUTTON_DURATION);
                        Animation animation5 = AnimationUtils.loadAnimation(BombScore.this, R.anim.anim_for_title_left);
                        animation5.setDuration(GameSettings.ANIMATION_SHOW_TITLE_DURATION);
                        Animation animation6 = AnimationUtils.loadAnimation(BombScore.this, R.anim.anim_for_title_middle);
                        animation6.setDuration(GameSettings.ANIMATION_SHOW_TITLE_DURATION);
                        Animation animation7 = AnimationUtils.loadAnimation(BombScore.this, R.anim.anim_for_title_right);
                        ...
                        handler.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                Intent settingsIntent = new Intent(BombScore.this, MainMenu.class);
    ...
    // Display best score of the player in bomb mode.
    ...
    // update best score in bomb mode of the player.
    private void setHighScore() {
        ...
        int highScore = preferences.getInt(GameSettings.BEST_SCORE_BOMB, 0);
        int lastScore = preferences.getInt("Score", 0);
        if(lastScore > highScore) {
            editor.putInt(GameSettings.BEST_SCORE_BOMB, lastScore);
            editor.commit();
            highScore = lastScore;
        }
